...
live_trading_manager = LiveTradingManager(
    LiveTradingConfig(
        ...
        type_b_funding_history_enabled=bool(WATCHLIST_CONFIG.get('type_b_funding_history_enabled', True)),
        type_b_funding_history_window_hours=float(WATCHLIST_CONFIG.get('type_b_funding_history_window_hours', 48.0)),
        type_b_funding_history_min_hours=int(WATCHLIST_CONFIG.get('type_b_funding_history_min_hours', 12)),
        type_b_funding_history_dead_band_bp=float(WATCHLIST_CONFIG.get('type_b_funding_history_dead_band_bp', 1.0)),
        type_b_funding_history_allow_insufficient=bool(WATCHLIST_CONFIG.get('type_b_funding_history_allow_insufficient', True)),
        type_b_funding_history_range_bp=float(WATCHLIST_CONFIG.get('type_b_funding_history_range_bp', 120.0)),
        type_b_funding_history_std_bp=float(WATCHLIST_CONFIG.get('type_b_funding_history_std_bp', 22.0)),
        type_b_funding_history_mean_abs_bp=float(WATCHLIST_CONFIG.get('type_b_funding_history_mean_abs_bp', 35.0)),
        type_b_funding_history_sign_changes=int(WATCHLIST_CONFIG.get('type_b_funding_history_sign_changes', 5)),
        type_b_funding_history_net_mean_loss_4h_bp=float(WATCHLIST_CONFIG.get('type_b_funding_history_net_mean_loss_4h_bp', 20.0)),
        type_b_funding_history_net_range_bp=float(WATCHLIST_CONFIG.get('type_b_funding_history_net_range_bp', 60.0)),
        type_b_funding_history_net_sign_changes=int(WATCHLIST_CONFIG.get('type_b_funding_history_net_sign_changes', 10)),
        type_b_funding_history_cache_ttl_seconds=float(WATCHLIST_CONFIG.get('type_b_funding_history_cache_ttl_seconds', 300.0)),
        db_path=str(WATCHLIST_CONFIG.get('db_path', 'market_data.db')),
